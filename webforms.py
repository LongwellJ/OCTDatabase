...
class PostForm(FlaskForm):
    ...
    bcva =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
    ...
    bcva2 =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
    iop2 =DecimalField("IOP (mmHg)", validators=[optional()], places=2)
    date4 = DateField("Date", validators=[optional()])
    bcva3 =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
    ...
    bcva4 =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
    ...
    bcva5 =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
    ...
    bcva6 =StringField("BCVA (snellen), for non-numerical values please use one of the following: CF/HM/LP/NLP",validators=[optional()])
